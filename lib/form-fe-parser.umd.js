...
/* unused harmony export isBooleanStr */
...
var emit = function emit(event) {
  return new Promise(function (resolve, reject) {
    switch (event) {
      ...
      case 'submit':
        {
          console.log(componentList); // eslint-disable-next-line no-useless-call
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("159b");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("15fd");
/* harmony import */ var _Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("ade3");
/* harmony import */ var _vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("2638");
/* harmony import */ var _vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("3835");
/* harmony import */ var _Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("5530");
/* harmony import */ var _utils_formGenerator_index__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("055d");
/* harmony import */ var _components_FormGenerator_render_render_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("b865");
/* harmony import */ var _parseHooks__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("7439");
...
var layouts = {
  colFormItem: function colFormItem(h, scheme) {
    ...
    }, [h(_components_FormGenerator_render_render_js__WEBPACK_IMPORTED_MODULE_17__[/* default */ "a"], {
      "attrs": {
        "conf": scheme
      },
      "on": Object(_Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])({}, listeners)
    })])]);
  },
  ...
  tdItem: function tdItem(h, currentItem, index, list, parentList, root, tableRoot) {
    ...
    var config = currentItem.__config__;
    var child = renderChildren.apply(this, arguments);
    return h(_components_FormGenerator_render_render_js__WEBPACK_IMPORTED_MODULE_17__[/* default */ "a"], {
      "key": config.renderKey,
      "attrs": {
        "conf": currentItem
      },
  ...
  businessTable: function businessTable(h, currentItem, index, list, parentList) {
    ...
    return h("el-col", {
      ...
      "on": {
        "click": function click() {
          var newItem = Object(_utils_formGenerator_index__WEBPACK_IMPORTED_MODULE_16__[/* deepClone */ "a"])(currentItem.data[currentItem.data.length - 1]);

          for (var _i = 0, _Object$entries = Object.entries(newItem); _i < _Object$entries.length; _i++) {
            var _Object$entries$_i = Object(_Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(_Object$entries[_i], 2),
          ...
          newItem.dataKey = Object(_utils_formGenerator_index__WEBPACK_IMPORTED_MODULE_16__[/* generateUUID */ "b"])();
    ...
    }, ["\u5220\u9664"])]), h(_components_FormGenerator_render_render_js__WEBPACK_IMPORTED_MODULE_17__[/* default */ "a"], {
      "key": config.renderKey,
      "attrs": {
        "conf": currentItem
      },
...
function renderFrom(h) {
  ...
  }, [h("el-form", _vue_babel_helper_vue_jsx_merge_props__WEBPACK_IMPORTED_MODULE_13___default()([{
    "attrs": {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  name: 'ParserCom',
  components: {
    render: _components_FormGenerator_render_render_js__WEBPACK_IMPORTED_MODULE_17__[/* default */ "a"]
  },
  props: {
    formConf: {
      type: Object,
  ...
  data: function data() {
    ...
    var data = (_data = {
      formConfCopy: Object(_utils_formGenerator_index__WEBPACK_IMPORTED_MODULE_16__[/* deepClone */ "a"])(this.formConf)
    }, Object(_Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_data, FORM_MODEL, {}), Object(_Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_data, FORM_RULES, {}), _data);
    self = this;
  ...
  watch: {
    formConf: {
      ...
      handler: function handler(data) {
        self.formConfCopy = Object(_utils_formGenerator_index__WEBPACK_IMPORTED_MODULE_16__[/* deepClone */ "a"])(data || {});
        ...
        self.initFormData(self.formConfCopy.fields, self[FORM_MODEL]); // self.setForm()
      }
    },
    config: {
      deep: true,
      handler: function handler(config) {// this.setForm()
      }
    }
  },
  created: function created() {
    ...
    if (Object.keys(this.formConfCopy).length > 0) {
      Object(_parseHooks__WEBPACK_IMPORTED_MODULE_18__[/* buildHooks */ "a"])(this); // this.setForm()
  ...
  methods: {
    ...
    resetForm: function resetForm() {
      this.formConfCopy = Object(_utils_formGenerator_index__WEBPACK_IMPORTED_MODULE_16__[/* deepClone */ "a"])(this.formConf);
    ...
    submitFormHook: function submitFormHook() {
      ...
      return new Promise(function (resolve, reject) {
        _this10.$refs[_this10.formConf.formRef].validate(function (valid) {
    ...
    submitForm: function submitForm() {
      ...
      this.$refs[this.formConf.formRef].validate(function (valid) {
        ...
        var formData = _this11.getFormData(); // 触发sumit事件


        _this11.$emit('submit', formData);
    ...
    getFormData: function getFormData() {
      // 处理数据
      var formData = Object(_utils_formGenerator_index__WEBPACK_IMPORTED_MODULE_16__[/* deepClone */ "a"])(this[FORM_MODEL]); // 业务表格
        ...
        if (item.__config__.layout === 'businessTable') {
          ...
          item.data.forEach(function (v) {
            ...
            var dataKey = v.dataKey,
                reset = Object(_Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(v, ["dataKey"]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"3bb85298-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/FormGenerator/parser/Parser.vue?vue&type=template&id=eb52bb22&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.isShowParser)?_c('parser-com',{attrs:{"form-conf":_vm.formConf,"config":_vm.config},on:{"submit":_vm.onSubmit}}):_vm._e()}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/FormGenerator/parser/Parser.vue?vue&type=template&id=eb52bb22&
