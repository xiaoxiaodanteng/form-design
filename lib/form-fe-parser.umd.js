...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created: function created() {
    Object(_parseHooks__WEBPACK_IMPORTED_MODULE_18__[/* buildHooks */ "a"])(this);
    this.setForm();
  },
  ...
  methods: {
    ...
    setForm: function setForm() {
      ...
      this.formConfCopy = Object(_Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(Object(_Users_qinsihui_Documents_sunvalley_work_form_editor_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])({}, this.formConfCopy), this.config);
    },
    initFormData: function initFormData(componentList, formData) {
      ...
      componentList.forEach(function (cur) {
        ...
        if (config.children) _this9.initFormData(config.children, formData);
      });
    },
    buildRules: function buildRules(componentList, rules) {
      ...
      componentList.forEach(function (cur) {
        ...
        if (config.children) _this10.buildRules(config.children, rules);
      });
    },
    ...
    submitFormHook: function submitFormHook() {
      ...
      return new Promise(function (resolve, reject) {
        _this11.$refs[_this11.formConf.formRef].validate(function (valid) {
          if (!valid) return reject(false);

          var formData = _this11.getFormData();
    ...
    submitForm: function submitForm() {
      ...
      this.$refs[this.formConf.formRef].validate(function (valid) {
        ...
        var formData = _this12.getFormData(); // 触发sumit事件


        _this12.$emit('submit', formData);
    ...
    getFormData: function getFormData() {
      // 处理数据
      var formData = Object(_utils_formGenerator_index__WEBPACK_IMPORTED_MODULE_16__[/* deepClone */ "a"])(this[this.formConf.formModel]); // 业务表格
