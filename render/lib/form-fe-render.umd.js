(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory() } else if (typeof define === 'function' && define.amd) { define([], factory) } else if (typeof exports === 'object') { exports['form-fe-render'] = factory() } else { root['form-fe-render'] = factory() }
 ...
 */
      ...
      function buildDataObject(confClone, dataObject) {
        ...
        for (var _i = 0, _Object$entries = Object.entries(this.$listeners); _i < _Object$entries.length; _i++) {
          ...
          var eventKey = _Object$entries$_i[0]
          var event = _Object$entries$_i[1]
